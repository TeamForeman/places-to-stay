  ...
  return (
    <MainHead>
      <LogoDiv>
        ...
        <MainTitle>
          <i class="fas fa-paw"></i>  beartnt
        </MainTitle>
      </LogoDiv>
      <HeadButton>
        <SearchLabel>Start your search</SearchLabel>
        <SearchIconDiv>
      ...
      <MainNav>
        ...
        <UserButton>
          ...
          <ProfilePicture src='https://beartnt-profile-photos.s3.us-east-2.amazonaws.com/beartnt+profile+photos/pexels-photo-1310522.jpeg'></ProfilePicture>
        </UserButton>
      </MainNav>
    </MainHead>
  );
