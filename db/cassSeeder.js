...
function listingStream(i) {
  for (; i < seedAmount; i ++) {
    if (!writeListings.write(`${i}, ${Math.floor(Math.random() * seedAmount) + 1}, ${houseTypes[Math.floor(Math.random() * houseTypes.length)]}, ${Math.floor(Math.random() * 10 + 1)}, ${imagePath + Math.floor(Math.random() * 1000 + 1)}.jpg, ${faker.random.boolean()}, ${(Math.random() * 5).toFixed(2)}, ${Math.floor(Math.random() * 300)}, ${faker.lorem.sentence()}, ${(Math.random() * 1000).toFixed(2)}` + '\n')) {
...
function usersFavsJoinStream(i) {
  for (; i < seedAmount; i ++) {
    if (!writeUsersFavs.write(`${i}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}` + '\n')) {
...
function favoritesStream(i) {
  for (; i < seedAmount; i ++) {
    if (!writeFavorites.write(`${i}, ${favoriteTitles[Math.floor(Math.random() * favoriteTitles.length)]}, ${Math.floor(Math.random() * seedAmount) + 1}` + '\n')) {
...
function relatedListingsStream(i) {
  for (; i < seedAmount; i ++) {
    if (!writeRelatedListings.write(`${i}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)},${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}, ${Math.floor(Math.random() * seedAmount + 1)}` + '\n')) {
...
function usersStream(i) {
  for (; i < seedAmount; i ++) {
    if (!writeUsers.write(`${i}` + '\n')) {
      writeUsers.once('drain', function() {
        usersStream(i + 1);
      });
      return;
    }
